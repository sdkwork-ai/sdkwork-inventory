# sdkwork-inventory Source Configuration
...
| Item | Value |
| --- | --- |
| `appId` | `sdkwork-inventory` |
| `runtimeCode` | `inventory` |
| Config root | `/etc/sdkwork/inventory/` |
| Runtime TOML | `/etc/sdkwork/inventory/config.toml` |
| Secrets | `/etc/sdkwork/inventory/secrets/` |
| Override | `SDKWORK_INVENTORY_CONFIG_FILE` |

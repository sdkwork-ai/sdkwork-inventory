# Runbook — sdkwork-inventory deploy / upgrade / rollback (EN)
...
targets. Image reference: `registry.sdkwork.com/apps/sdkwork-inventory-standalone:0.1.0`
...
install syncs the bundle to `/opt/deploy/sdkwork-inventory/bundle`, loads the image, starts
